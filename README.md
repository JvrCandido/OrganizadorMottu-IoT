...
│   └── main.py
│── OrganizadorMottu.py         # Classe principal do sistema
...
```bash
git clone https://github.com/JvrCandido/OrganizadorMottu-iot.git
cd OrganizadorMottu-iot
```
...
DATABASE_URL=sqlite:///OrganizadorMottu.db
...
Banco: **SQLite** (`OrganizadorMottu.db`)
