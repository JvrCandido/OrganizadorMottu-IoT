#!/usr/bin/env python3
"""
Organizador Mottu  - Demonstração Final
...
class FleetZoneDemo:
    """Demonstração completa do sistema Organizador Mottu """
    ...
    def run_detection_demo(self, max_frames=50):
        ...
        while frame_count < max_frames:
            ...
            # Exibe frame
            cv2.imshow("FleetZone - Demonstração", frame)
    ...
    def run_complete_demo(self):
        ...
        print("🎯 FleetZone - Demonstração Completa")
        print("=" * 50)
        ...
        try:
            ...
            print("\n🎉 FleetZone - Sistema Completo Funcionando!")
